...
<div class="card" style=" margin-bottom: 100px">
    <div class="card-body">
        ...
        <div class="form-group">
            ...
            <input type="teks" name="nama_pegawai" class="form-control" value="<?php echo $p->nama_pegawai?>">
            <?php echo form_error('nama_pegawai','<div class="text-small text-danger"></div>')?>
        </div>
        <div class="form-group">
                <label>Username</label>
                <input type="teks" name="username" class="form-control" value="<?php echo $p->username?>">
                <?php echo form_error('username','<div class="text-small text-danger"></div>')?>
            </div>
            <div class="form-group">
                <label>Password</label>
                <input type="teks" name="password" class="form-control" value="<?php echo $p->password?>">
        ...
        <div class="form-group">
            ...
            <select name="status" class="form-control">
                ...
                <option value="pegawai Tetap">Pegawai Tatap</option>
