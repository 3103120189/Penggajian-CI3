...
<div class="container-fluid">
    ...
    <table class="table table-bordered table-striped">
        <tr>
            ...
            <td class="text-center">Jabtan</td>
    ...
    <?php }else{ ?>
        <span class="badge badge-danger"><i class="fas fa-info-circle"></i> Data masih kosong, silahkan input data kehadiran pada bulan 
